...
public class FPSWeaponTrigger : MonoBehaviour
{
	...
	public void Fire()
	{
		...
		Rigidbody component = (Object.Instantiate(Shell.gameObject, ShellEjectionTransform.position, ShellEjectionTransform.rotation) as GameObject).GetComponent<Rigidbody>();
